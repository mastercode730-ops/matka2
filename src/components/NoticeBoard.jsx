  ...
  return (
    <div className="w-full flex flex-col items-center gap-4 my-4">
      ...
      <div className="w-full max-w-[600px] p-[2px] bg-gradient-to-r from-brand-red via-brand-yellow to-brand-red rounded-xl shadow-[0_5px_15px_rgba(0,0,0,0.3)]">
        <div className="bg-[#1a1a1a] p-3 rounded-[10px] text-center text-white">
          ...
          <div className="flex justify-between gap-2">
            <a href="https://wa.me/918360750829" target="_blank" rel="noreferrer" className="flex-1 p-2 rounded-lg text-white font-bold text-[10px] uppercase flex items-center justify-center transition-transform active:scale-95 bg-gradient-to-tr from-[#0088cc] to-[#00a2ed] shadow-[0_4px_10px_rgba(0,136,204,0.3)] hover:opacity-90">
              <i className="fab fa-telegram-plane mr-2 text-xs"></i> Telegram Now
            </a>
            <a href="https://wa.me/918360750829" target="_blank" rel="noreferrer" className="flex-1 p-2 rounded-lg text-white font-bold text-[10px] uppercase flex items-center justify-center transition-transform active:scale-95 bg-gradient-to-tr from-[#25d366] to-[#128c7e] shadow-[0_4px_10px_rgba(37,211,102,0.3)] hover:opacity-90">
      ...
      <div className="w-full max-w-[600px] px-[5px]">
        <a href="https://wa.me/918360750829" target="_blank" rel="noreferrer" className="animate-pulse-blue bg-gradient-to-br from-[#0088cc] to-[#005588] rounded-xl flex flex-col items-center text-center p-3 text-white no-underline shadow-[0_4px_15px_rgba(0,136,204,0.4)] transition-transform hover:-translate-y-0.5 hover:shadow-[0_6px_20px_rgba(0,136,204,0.6)] border border-white/20">
          <div className="mb-2">
