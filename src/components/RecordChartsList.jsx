...
const ChartSection = ({ year }) => (
  <div className="w-full flex flex-col mb-1">
    ...
    <div className="flex flex-col gap-[2px] mt-[2px] px-[2px]">
      {games.map(game => (
        <a key={game} href="https://wa.me/918360750829" className="bg-white border border-black rounded-full text-center py-1.5 text-black hover:bg-gray-100 uppercase text-[10px] sm:text-xs font-bold font-serif shadow-sm block w-full">
  ...
  return (
    <div className="w-full py-2">
      ...
      <div className="w-full flex flex-col mb-1 mt-4">
        ...
        <div className="flex flex-col gap-[2px] mt-[2px] px-[2px]">
          <a href="https://wa.me/918360750829" className="bg-white border border-black rounded-full text-center py-1.5 text-black hover:bg-gray-100 uppercase text-[10px] sm:text-xs font-bold font-serif shadow-sm block w-full">
